# DOCUMENTO DE COMPRENSIÓN Y CONSENTIMIENTO DE ACTIVIDAD TANDEM (TÉRMINOS Y CONDICIONES)
...
> `src/lib/waiver-templates/waiver.ts` y se sirve por QR. Este fichero es el
> espejo en papel de esa versión. Actualizado el 2026-09-10 para eliminar la
> divergencia de nombre y la referencia legal no verificable. Si se edita uno
> de los dos, hay que editar el otro.
...
## Declaraciones de comprensión de la actividad

En la versión digital, cada una de estas declaraciones es una casilla independiente que el alumno marca el día del salto (`HEALTH_ITEMS` en `waiver.ts`).

- **Riesgo de lesión:** Soy consciente de que el paracaidismo es un deporte potencialmente peligroso y puede causar lesiones o la muerte.
- **Comodidad personal:** Soy consciente de que para realizar un salto tándem es necesario un contacto corporal muy cercano con mi instructor durante la mayor parte de la experiencia, incluyendo ser solicitado para sentarme en sus piernas cuando esté en la aeronave, para ajustar el arnés.
- **Emergencias en aeronaves:** Seguiré cualquier instrucción dada por mi instructor en caso de emergencia en la aeronave.
...
- **Salida de la aeronave:** Estoy familiarizado/a con la posición del cuerpo antes del salto (cabeza hacia atrás, piernas juntas, arqueo, manos en el arnés).
- **Caída libre:** Entiendo los procedimientos de salida y soy consciente de la importancia de una buena posición del cuerpo arqueada para una salida exitosa. No agarraré ninguna parte del instructor en ningún momento.
- **Descenso en paracaídas:** NO alcanzaré las áreas del equipo a menos que se me indique lo contrario y seguiré las órdenes del instructor en todo momento. Informaré al instructor si me siento mal en cualquier momento.
- **Aterrizaje:** Soy consciente de la importancia de la posición correcta de aterrizaje (de pie/sentado deslizándose). MANTENDRÉ las piernas ALTAS para el aterrizaje.

En Casas de los Pinos, a de de 20 .

COMPRENDO Y CONSIENTO
